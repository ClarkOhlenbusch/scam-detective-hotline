...
This weekend, we built a working hackathon prototype of **The Scam Detective Hotline**: users can submit their phone number, tap **Open a Case**, and receive a fast AI callback for a **live** second opinion. We also developed and tested the core user flow and voice/scam test scenarios.
